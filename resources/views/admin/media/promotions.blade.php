    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-lg">
                ...
                <form id="create_promotion" action="{{ route('admin.media.create.promotion') }}" method="post" enctype="multipart/form-data">
                    @csrf
...
<script>
    $(function() {
        NioApp.DataTable($('#promotion_table'), {
            ajax: {
                url: `{{ route('ajax.get.all.promotions') }}`,
                dataSrc: 'promotions'
            },
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body modal-body-lg">
                                        ...
                                        <dl class="row pt-3">
                                            ...
                                            <dd class="col-sm-9">
                                                <img class="cover-image" src="${data.material}" alt="${data.title}">
                                            </dd>
