                ...
                <form id="create_video" action="{{ route('admin.media.create.video') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap number-spinner-wrap">
                            ...
                            <input type="number" id="earned_after" name="earned_after" class="form-control number-spinner @error('earnable') is-invalid @enderror" value="1">
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    ...
                                                    <li><a href="{{ route('admin.media.edit.video') }}/${data.id}"><em class="icon ni ni-edit"></em><span>Edit Video</span></a></li>
                                                    <li class="divider"></li>
                                                    ${video_status}
                                                </ul>
                                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body modal-body-lg">
                                                ...
                                                <dl class="row pt-3">
                                                    ...
                                                    <dd class="col-sm-9">${data.length}</dd>
                                                    ...
                                                    <dd class="col-sm-9">&#8358;${data.earned_after}</dd>
