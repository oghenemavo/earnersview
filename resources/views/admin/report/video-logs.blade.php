...
<script>
    $(function() {
        NioApp.DataTable($('#video_logs_table'), {
            ajax: {
                url: `{{ route('ajax.get.all.video.logs') }}`,
                dataSrc: 'video_logs'
            },
        ...
        $('#video_logs_table tbody').on('click', 'a.requery-transaction', function(e) { // activate user
            e.preventDefault();

            const dt = $.fn.DataTable.Api($('#video_logs_table'));
