                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 400; margin-bottom: 8px;">Your Event has been Verified & Approved.</h2>
                                    <p>Our team approved {{ $event->title }}. Your event is now whitelisted for ticket sale.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
