                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    ...
                                    <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Ticketters Payout</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 400; margin-bottom: 8px;">{{ $amount }} has been paid to your account.</h2>
                                    <p>Account: {{ $account }}</p>
                                    <p>Bank: {{ $bank }}</p>
                                    <p>Amount: {{ $amount }}</p>
                                </td>
