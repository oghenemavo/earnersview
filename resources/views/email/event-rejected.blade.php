                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 400; margin-bottom: 8px;">Your Event has been Rejected.</h2>
                                    <p>Our team Rejected {{ $event->title }}. Your event has been Rejected, contact admin for more information.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
