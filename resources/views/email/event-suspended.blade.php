                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    ...
                                    <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Ticketters Events Request Status</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    <img style="width:88px; margin-bottom:24px;" src="images/kyc-success.png" alt="Verified">
                                    <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 400; margin-bottom: 8px;">Your Event has been Suspended.</h2>
                                    <p>Our team Suspended {{ $event->title }}. Your event has been Suspended, contact admin for more information.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © 2020 Ticketters. All rights reserved. </p>
                                    ...
                                    <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="{{ url('/') }}">Ticketters</a>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
