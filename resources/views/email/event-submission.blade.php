                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <h2 style="font-size: 18px; color: #6576ff; font-weight: 400; margin-bottom: 8px;">Your Request under Process for Varification.</h2>
                                    <p>You have successfully submitted {{ $event->title }} for approval.</p>
                                    <p>We are still working on your event verification. Once our team verified your event, you will be whitelisted and notified by email.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
